...
def predict():
    ...
    suggestion = {
        0: "Excellent focus. Keep it up!",
        1: "Balanced session. Slight improvements can help.",
        2: "Low productivity. Try reducing distractions."
    }.get(prediction, "Unknown category.")

    return jsonify({"category": int(prediction), "suggestion": suggestion})
